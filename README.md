##[![Typing SVG](https://readme-typing-svg.herokuapp.com/?lines=Welcome+To+HyDrix!;created+by+HyDrix;A+simple+autofilter+Bot!;Auto+filter+with+double+button!;start+message+with+pic!;and+all+futures!)
</p>
