##[![Typing SVG](https://readme-typing-svg.herokuapp.com/?lines=welcome+To+HyDrix;created+by+𝑻𝑬𝑨𝑴+𝑨𝑵𝑵𝑨+𝑩𝑬𝑵!;A+simple+autofilter+Bot!;Auto+filter+with+double+button!;start+message+with+pic!;and+all+futures!)
</p>
